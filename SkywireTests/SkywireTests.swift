...
class SkywireTests: XCTestCase {
    ...
    func testCreatingLocationData() {
        let locationData = LocationData(timestamp: 0, latitude: 0, longitude: 0, altitude: 0, baroAltitude: 0, heading: 0)
        XCTAssertNotNil(locationData)
    }
    
    func testLocationDataMinMaxValues() {
        let locationData1 = LocationData(timestamp: 0, latitude: -90, longitude: -180, altitude: -1000, baroAltitude: 0, heading: 0)
        let locationData2 = LocationData(timestamp: 0, latitude: 90, longitude: 180, altitude: 100000, baroAltitude: 0, heading: 360)
    ...
    func testSavingMultipleLocationData() {
        let locationData1 = LocationData(timestamp: 0, latitude: 0, longitude: 0, altitude: 0, baroAltitude: 0, heading: 0)
        let locationData2 = LocationData(timestamp: 1, latitude: 1, longitude: 1, altitude: 100, baroAltitude: 0, heading: 45)
        let recorder = LocationDataRecorder()
